...
assert(runtime.includes("lexemeIdentity.attachLexemeIdentity")&&runtime.includes("rankChineseCandidates"),"local lookup must consume the shared lexeme and candidate-ranking authorities");
