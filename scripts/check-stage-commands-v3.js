...
assert(transition.includes('appendActivity(data,card.id,"select",{commandId})'),"Select completion must persist its command ID");
assert(transition.includes('appendActivity(data,card.id,"visualize",{skipped:false,commandId})'),"normal Visualize completion must persist its command ID");
assert(transition.includes('appendActivity(data,card.id,"apply",{sentence,skipped:false,commandId})'),"normal Apply completion must persist its command ID");
