(() => {
  ...
  function injectStyle(){
    ...
    style.textContent=`
      ...
      .lexi-source-box-head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;margin-bottom:12px}.lexi-source-box-head strong{font-size:13px;font-weight:650}.lexi-source-box-head span{font-size:11px;color:var(--muted);line-height:1.5;text-align:right}
      .lexi-source-grid{display:grid;grid-template-columns:minmax(160px,.7fr) minmax(220px,1.3fr);gap:10px}.lexi-source-grid .field{margin:0}.lexi-source-context-field{grid-column:1/-1}.lexi-source-box .field label{font-size:11px}.lexi-source-box .input,.lexi-source-box .textarea{font-size:12.5px}.lexi-source-box textarea{min-height:84px}.lexi-source-reminder{margin:10px 0 16px;padding:11px 13px;border:1px solid var(--line);border-radius:14px;background:rgba(120,140,132,.045);font-size:12px;line-height:1.65;color:var(--muted)}.lexi-source-reminder strong{display:block;color:var(--text);font-size:12px;margin-bottom:2px}.lexi-source-tag{display:inline-flex;margin-right:6px;padding:3px 7px;border-radius:999px;border:1px solid var(--line);font-size:11px;color:var(--muted)}
