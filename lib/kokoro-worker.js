...
function configureModelCache() {
  ...
  // kokoro-js delegates model loading to Transformers.js. Configure that
  // instance too so development and packaged builds use LexiFlow's app-data
  // cache rather than a mutable cache inside node_modules.
  try {
...
async function createModel() {
  const KokoroTTS = configureModelCache();
